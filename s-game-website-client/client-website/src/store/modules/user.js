...
const state = {
  ...
  userIconUrlConfig: [
    'static/images/homepage/user-icon/user-icon-0.png',
    'static/images/homepage/user-icon/user-icon-1.png',
    'static/images/homepage/user-icon/user-icon-2.png',
    'static/images/homepage/user-icon/user-icon-3.png',
    'static/images/homepage/user-icon/user-icon-4.png',
    'static/images/homepage/user-icon/user-icon-5.png',
    'static/images/homepage/user-icon/user-icon-6.png',
    'static/images/homepage/user-icon/user-icon-7.png',
    'static/images/homepage/user-icon/user-icon-8.png',
    'static/images/homepage/user-icon/user-icon-9.png',
    'static/images/homepage/user-icon/user-icon-10.png',
    'static/images/homepage/user-icon/user-icon-11.png',
    'static/images/homepage/user-icon/user-icon-12.png',
  ],
};
